...
[**Watch the 64-second deployment demo**](docs/alia-deployment-demo.mp4)

The recording captures the application running through a temporary Back4App HTTPS URL.
It demonstrates authenticated text chat, streamed responses, visible connection and
generation states, speech input, voice output, and the full-screen avatar experience.
The recorded URL is evidence of that deployment, not a permanent live endpoint; free
Back4App preview addresses expire and rotate.
